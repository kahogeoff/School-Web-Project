    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               ...
               da = new DatabaseAccess();
                ...
                String wait2hash2 =username+"_"+newpassword;
                ...
                String matchpwdhash2=String.format("%064x", new java.math.BigInteger(1, digest2));
                 ...
                 da.modifyData("update click_user set user_password='"+matchpwdhash2+"'"+ " where user_password = '" +matchpwdhash+"' and user_id = '" + "YENLIN'"  );
