...
public class ProfileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            rs = da.getResultSet("SELECT * FROM click_user WHERE user_id='" + user_id + "'");
            if (!rs.isBeforeFirst()) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           da.modifyData("update click_user set user_name='"+username+"', user_email='"+useremail+"', user_contactNum='"+userContact+"', user_age='"+userage+"'"+
                         ", img_Base64='"+imagebase64 + "'where user_id = '" + user_id+"'" );
